...
public class IntHistogramTest {
	...
	@Test public void opGreaterThanTest() {
		...
		Assert.assertTrue(h.estimateSelectivity(Op.GREATER_THAN, 3) > 0.1); // I added this test. Answer should be 0.2
	...
	@Test public void opLessThanTest() {
		...
		Assert.assertTrue(h.estimateSelectivity(Op.LESS_THAN, 3) > 0.1); // answer should be 0.2
